...
class RectangularRoom(object):
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        return pos.getX() >= 0 and pos.getY() >= 0 and math.floor(pos.getY()) < self.height and math.floor(pos.getX()) < self.width
...
class Robot(object):
    ...
    def getRobotDirection(self):
        ...
        degrees, 0 <= d < 360.
        """
        if self.direction >= 0 and self.direction < 360:
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        newp = p.getNewPosition(self.getRobotDirection(), self.speed)
...
#     plot.
#
showPlot2("My plot", "Width", "Height")
#
